const SymbolSection = () => {
  return <section className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-purple-900 py-20 px-4 sm:px-6 lg:px-8 flex items-center">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mb-16 flex justify-center">
          <div className="relative group">
            ...
            <div className="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96 animate-logo-float">
              <img src="/lovable-uploads/a58f20d0-fc74-4368-a2da-2040d63e3065.png" alt="The Innovators - Octopus Shield Symbol" className="w-full h-full object-contain drop-shadow-2xl" />
        ...
        <div className="space-y-8">
          ...
          <p className="text-lg sm:text-xl text-gray-400 font-inter leading-relaxed max-w-3xl mx-auto">The octopus represents adaptability, intelligence, and the ability to solve problems from multiple angles simultaneously. Each arm an autonomous agent, working together to grasp a shield, a symbol of protection and responsibility for those ready to step into their own agency
