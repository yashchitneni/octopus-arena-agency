...
const WhatsNextSection = () => {
  ...
  return <section className="min-h-screen bg-gradient-to-br from-black via-purple-900 to-gray-900 py-20 px-4 sm:px-6 lg:px-8 flex items-center">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="space-y-12">
          ...
          <div className="space-y-6 my-16">
            <button onClick={handleCallClick} className="bg-gradient-to-r from-deep-violet to-electric-blue text-white px-8 py-4 rounded-lg font-orbitron font-semibold text-lg hover:from-electric-blue hover:to-deep-violet transition-all duration-300 transform hover:scale-105">
              What's the distance?
            </button>
            
            {showResponse && <div className="animate-fade-in-up">
