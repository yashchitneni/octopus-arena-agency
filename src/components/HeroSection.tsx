    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-black via-gray-900 to-purple-900">
      ...
      <div className="absolute inset-0 overflow-hidden">
        {[...Array(20)].map((_, i) => (
          <div
            key={i}
            className="absolute w-1 h-1 bg-electric-blue rounded-full opacity-30 animate-pulse"
            style={{
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-7xl font-orbitron font-bold text-white mb-6 animate-fade-in-up tracking-tight">
          <span className="bg-gradient-to-r from-white via-electric-blue to-deep-violet bg-clip-text text-transparent">
            Enter the
          </span>
          <br />
        ...
        {/* Tagline */}
        <div
          className="space-y-4 mb-8 sm:mb-12 animate-fade-in-up"
          style={{
            animationDelay: '0.3s',
        ...
        >
          <Button
            ...
            size="lg"
            className="bg-gradient-to-r from-arena-purple to-deep-violet hover:from-deep-violet hover:to-arena-purple text-white font-orbitron font-semibold px-8 py-4 text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-purple-500/25 border border-purple-400/30"
          >
            Step In
